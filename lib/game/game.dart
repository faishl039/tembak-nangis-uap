...
class MyGame extends FlameGame with PanDetector, HasCollisionDetection {
  ...
  Future<void>? onLoad() async {
    final playerImage = await images.load('rio.png');
    ...
    final opponentImage = await images.load('arve.png');
    _opponent = Player(isMe: false);
    _opponent.add(SpriteComponent.fromImage(opponentImage, size: spriteSize));
    add(_opponent);

    _playerBulletImage = await images.load('pmerah.png');
    _opponentBulletImage = await images.load('parve.png');
