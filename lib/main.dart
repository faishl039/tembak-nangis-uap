...
void main() async {
  await Supabase.initialize(
    url: 'https://xwcigvzlvwmnpwknaema.supabase.co',
    anonKey:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inh3Y2lndnpsdndtbnB3a25hZW1hIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MDQxMTY5MzcsImV4cCI6MjAxOTY5MjkzN30.B0GtyvvYx0U6JH3C6Q_dTeBbjxbPamEyKgXHuiRb7NA',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: Stack(
        fit: StackFit.expand,
        children: [
          Image.asset('assets/images/bgtembak.jpg', fit: BoxFit.cover),
